...
abstract class Analytics {
  ...
  static void logLogin(AuthenticatedUser user) => Stream<void>.fromFutures(<Future<void>>[
        ...
        FirebaseAnalytics.instance.setUserProperty(name: 'name', value: user.name.hashCode.toRadixString(36)),
        FirebaseAnalytics.instance.setUserProperty(name: 'email', value: user.email.hashCode.toRadixString(36)),
